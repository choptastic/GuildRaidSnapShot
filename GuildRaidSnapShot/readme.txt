...
changes to it as necessary to support your own DKP system (eqDKP, nDKP).

If you do, we'd be happy to hear how you've tweaked this mod to support your
particular system.

The only restriction about copying and tweaking is that credit be ALWAYS given
to DKPSystem.com in a prominent location.
